...
public class Parser {
	...
	public static void main(String[] args) {
		...
		System.out.println(Parser.parse("Agnes Väg 123").toString());
		System.out.println(Parser.parse("Agnes Väg 123B").toString());
		System.out.println(Parser.parse("Agnes Väg 123 444 94").toString());
		System.out.println(Parser.parse("Agnes Väg 123 444 94 Ucklum").toString());
		System.out.println(Parser.parse("Agnes Väg 123B 444 94 Ucklum").toString());
		System.out.println(Parser.parse("Agnes Väg 444 94 Ucklum").toString());
		...
		System.out.println(Parser.parse("Annas väg 444 94 Ucklum").toString());
		System.out.println(Parser.parse("AGNES VäG").toString());
		System.out.println(Parser.parse("Agnes Väg").toString());
	}
