...
//		System.out.println(Parser.parse("Annas v�g 123 444 94 Ucklum").toString());
//		System.out.println(Parser.parse("Annas v�g 123 444 94").toString());
//		System.out.println(Parser.parse("Annas v�g 123").toString());
		System.out.println(Parser.parse("Annas v�g").toString());
//		System.out.println(Parser.parse("Amdal 123 (444 94 Ucklum)").toString());
//		System.out.println(Parser.parse("Amdal 123 (444 94").toString());
//		System.out.println(Parser.parse("Amdal 123 (").toString());
//		System.out.println(Parser.parse("Amdal").toString());
//		System.out.println(Parser.parse("Annas v�g 123C 44494 Ucklum").toString());
//		System.out.println(Parser.parse("Annas v�g 123 444 94").toString());
//		System.out.println(Parser.parse("Annas v�g 123C").toString());
		System.out.println(Parser.parse("AGNES V�G").toString());
		System.out.println(Parser.parse("Agnes v�g").toString());
	}
