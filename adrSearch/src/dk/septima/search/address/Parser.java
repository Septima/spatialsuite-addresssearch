...
public class Parser {
	public static ParseResult parse(String input){
		...
		if (adrWork.length() == 1){
			...
			patterns[1] = Pattern.compile(pat_streetname + "[,\\ ]+([0-9]{1,3} *[A-Za-z]{0,1}),{0,1} [A-Za-zÆØÅæøåéüäöèÜÿ\\,\\ ]*$"); //Ramsherred 13 Brændstrup, flyttet ned da den overmatcher etager mv.
			patterns[2] = Pattern.compile(pat_streetname + "[,\\ ]+([0-9]{1,3} *[A-Za-z]{0,1})[,\\ ]+[A-Za-z0-9ÆØÅæøåéüäöèÜÿ\\.\\-\\ ''\\/\\(\\)]*"); //Skolegade 9 A, Øster Højst-
